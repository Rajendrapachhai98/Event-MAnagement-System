...
public class Statementlmpl extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                conn c = new conn();
                String query = "INSERT INTO projects (projectName, clientName, startDate, endDate, budget, projectManager, status) VALUES (?, ?, ?, ?, ?, ?, ?)";
